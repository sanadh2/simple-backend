...
export class AnalyticsController {
  ...
  static getRegistrationTrends = asyncHandler(async (req: Request, res: Response) => {
  ...
  static getActiveSessionsAnalysis = asyncHandler(async (_req: Request, res: Response) => {
  ...
  static getUsersPaginated = asyncHandler(async (req: Request, res: Response) => {
  ...
  static getInactiveUsers = asyncHandler(async (req: Request, res: Response) => {
    const days = parseInt(req.query.days as string) || 30;
  ...
  static getEmailDomainStats = asyncHandler(async (_req: Request, res: Response) => {
  ...
  static getCohortAnalysis = asyncHandler(async (_req: Request, res: Response) => {
